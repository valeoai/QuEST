...
run = 1
num_classes = 1000
num_filters_teacher = [2048]
depth_teacher = 50
num_filters_student = [1024]
num_embeddings = 4096
...
num_epochs='*'
pretrained_VQ = f'./experiments/VQ/Config_ImageNet/RN50/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'
...
net_optionsF = {#'width': width_student, 'add_reshape':True,
                'num_filters': num_filters_student, 'num_classes':num_classes, 'extract_from':['features'], 'extract_after_relu':[True], 'pretrained':None,
                'classifier_options':net_optionsC}

networks['student_net'] = {'def_file': 'feature_extractors.MobileNetV2_ImageNet',
