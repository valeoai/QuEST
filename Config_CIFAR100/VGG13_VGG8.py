...
num_classes = 100
num_filters_teacher = [[64, 64], [128, 128], [256, 256], [512, 512], [512, 512]]
num_filters_student = [[64], [128], [256], [512], [512]]
num_embeddings = 4096

networks = {}
pretrained_teacher = "./saved_models/vgg13_vanilla/ckpt_epoch_240.pth"

net_optionsF = {
    'num_filters': num_filters_teacher,
    'num_classes':num_classes, 'extract_from':['block4'], 'extract_after_relu':[False]}
...
num_epochs='*'
pretrained_VQ = f'./experiments/VQ/Config_CIFAR100/VGG13/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'

net_optionsVQ = {
    'num_embeddings': num_embeddings,
    'embedding_dim': num_filters_teacher[-1][-1],
