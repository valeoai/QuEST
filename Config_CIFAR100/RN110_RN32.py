...
networks = {}
pretrained_teacher = f'./saved_models/resnet110_vanilla/ckpt_epoch_240.pth'
...
num_epochs='*'
pretrained_VQ = f'./experiments/VQ/Config_CIFAR100/RN110/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'
