...
networks = {}
pretrained_teacher_base = f'./saved_models/resnet56_vanilla/'
...
num_epochs='*'
pretrained_VQ = f'./experiments/VQ/Config_CIFAR100/RN56/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'
