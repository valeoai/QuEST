...
net_optionsF = {'num_filters': num_filters_teacher,
...
num_epochs='*'
pretrained_VQ = f'./experiments/VQ/Config_CIFAR100/VGG13_downscale/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'
