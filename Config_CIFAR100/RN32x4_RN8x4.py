...
depth_teacher = 32
num_filters_student = [32, 64, 128, 256]
depth_student = 8
num_embeddings = 4096

networks = {}

pretrained_teacher_base = "./saved_models/resnet32x4_vanilla/"
pretrained_teacher = pretrained_teacher_base + 'ckpt_epoch_240.pth'
...
num_epochs='*'
pretrained_VQ = f'./experiments/VQ/Config_CIFAR100/RN32x4/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'
