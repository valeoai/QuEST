...
net_optionsF = {
    ...
    'num_classes':num_classes, 'extract_from':['avgpool_2x2'], 'extract_after_relu':[False], 'pool':'avg', 'downscale': True}
...
num_epochs='*'
pretrained_VQ = f'./experiments/VQ/Config_CIFAR100/WRN40w2_downscale/vector_quantizer_kmeansK{num_embeddings}_net_epoch{num_epochs}'
