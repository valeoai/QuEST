'''Source: https://github.com/HobbitLong/RepDistiller/blob/master/models/ShuffleNetv2.py'''
...
class BasicBlock(nn.Module):
    def __init__(self, in_channels, split_ratio=0.5, is_last=False, with_preact=False):
...
class ShuffleNetV2(nn.Module):
    def __init__(self, net_size, num_classes=10):
        ...
        self.reshape = tools.Reshape(-1, out_channels[3])
...
def create_model(opt):
    ...
    return ShuffleV2(num_classes=num_classes)
