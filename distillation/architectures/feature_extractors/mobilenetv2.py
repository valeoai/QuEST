'''Source: https://github.com/HobbitLong/RepDistiller/blob/master/models/mobilenetv2.py'''
"""
...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, T,
        ...
        self.reshape = tools.Reshape(-1, self.last_channel)
        # building classifier
...
def create_model(opt):
    ...
    return mobile_half(num_classes=num_classes)
