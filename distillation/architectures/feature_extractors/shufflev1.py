'''Source: https://github.com/HobbitLong/RepDistiller/blob/master/models/ShuffleNetv1.py'''
...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, out_planes, stride, groups, is_last=False, with_preact=False):
...
class ShuffleNet(nn.Module):
    def __init__(self, cfg, num_classes=10):
        ...
        self.reshape = tools.Reshape(-1, out_planes[2])
...
def create_model(opt):
    ...
    return ShuffleV1(num_classes=num_classes)
